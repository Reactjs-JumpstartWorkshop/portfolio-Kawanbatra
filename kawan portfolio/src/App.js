...
export default function App() {
  return (
    <div>
      ...
      <ul>
        <li>
          <b>Project name:</b>Hotel website
        </li>
        <ul>
          <li>
            <b>Tech used:</b>HTML,CSS,javascript,php,react javascript,Mysql
          </li>
          <li>
            <b>No.of team members:</b>4
          </li>
          <li>
            <b>Purpose of project:</b>To fascinate the customers with our food
            and bevarages with different schemes and discount and any person all
            over india can reach us through our hotel website.
          </li>
          <li>
            <b>My role in the project:</b>front-end Designing.
          </li>
          <li>
            <b>Duration of the project:</b>ongoing
          </li>
        </ul>
      </ul>
      <h2 style={{ color: "red" }}>
      ...
      <ul>
        <li>
          <b>Expert:</b>Mysql,CSS,HTML,Coding
        </li>
        <li>
          <b>Proficient:</b>Time Management,Critical Thinking,Verbal
          cmmunication
        </li>
        <li>
          <b>Novice:</b>Active listening,Public speaking
        </li>
      </ul>
      <h2 style={{ color: "red" }}>
      ...
      <ul>
        <li>
          <b>Computer Languages:</b>C,C++
        </li>
        <li>
          <b>Web Technologies:</b>HTML,CSS,Javascript,PHP
        </li>
        <li>
          <b>Database:</b>Mysql
        </li>
